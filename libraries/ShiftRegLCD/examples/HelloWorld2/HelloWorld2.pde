/* 3-wire connection demo to a HD44780-compatible LCD via shiftregister with:
     Data on Arduino pin 10
     Clock on Arduino pin 11
     LCD Enable on Arduino pin 12
...
ShiftRegLCD srlcd(dataPin, clockPin, enablePin);
